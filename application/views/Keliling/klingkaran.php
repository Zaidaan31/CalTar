      ...
      <div class="row">
        <div class="col-lg-12">
            <div class="container">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Perhitungan Keliling Lingkaran</h5>
                        <p>Rumus untuk perhitungan Keliling lngkaran adalah <b><i>K = 2 x π x r</i><b></p>
        ...
        <div class="col-lg-6">
          <div class="container">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Bentuk Lingkaran</h5>
