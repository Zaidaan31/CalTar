      ...
      <div class="row">
        <div class="col-lg-12">
            <div class="container">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Perhitungan Keliling Persegi</h5>
        ...
        <div class="col-lg-6">
          <div class="container">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Bentuk Persegi</h5>
                <p>Rumus untuk perhitungan keliling Persegi adalah <br>
                <b><i> K = 4 x sisi</i><b><br>
                <b><i> sisi = Keliling / 4</i><b>
                </p>
